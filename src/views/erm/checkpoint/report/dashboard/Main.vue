  ...
  <!--  div inferior donde se encunetran los botones-->
    ...
    <div class=" grid grid-cols-12 gap-5 h-auto ">
      <div class="  col-span-12 lg:col-span-8 grid grid-cols-8 gap-5" id="left-side">
        <!--inditatorBoxes-->
        <div class=" h-auto w-auto col-span-8 grid grid-cols-12 lg:gap-3  ">
          <indicator-boxes
              :dates="dates"
          >
          </indicator-boxes>
...
<!--        grafico de barra-->
<!--        <div class="  w-full h-full col-span-8   lg:gap-3">-->
<!--            <live-column-chart></live-column-chart>-->
<!--        </div>-->
<!--        grafico de torta y lineal-->
        <div class=" w-full h-full col-span-8 grid grid-cols-12    lg:gap-3 ">
          <new-pie-chart>
...
import LiveColumnChart from "@/views/erm/checkpoint/report/dashboard/sections/LiveColumnChart.vue"
import DataTable from "@/views/erm/checkpoint/report/dashboard/sections/DataTable.vue"
import moment from 'moment'
// import NewPieChart from "@/views/erm/checkpoint/report/dashboard/sections/NewPieChart.vue"
